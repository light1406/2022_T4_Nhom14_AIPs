...
public class WeatherServiceImpl implements WeatherService{
	...
	public List<Weather> getAll(){
		...
		weatherFactResponsitory
			...
			.forEach(w -> {
				...
				weather.setProvinceName(provinceDimResponsitory.findById(w.getProvinceId()).get().getNameProvince());
				Date date = new Date();
	...
	public Weather getWeatherById(String id) {
		WeatherFact w = weatherFactResponsitory.getById(id);
		Weather weather = new Weather();
		weather.setId(w.getNaturalKey());
		weather.setProvinceName(provinceDimResponsitory.findById(w.getProvinceId()).get().getNameProvince());
		Date date = new Date();
		...
		weather.setUvIndex(w.getUvIndex());
		weather.setAirQuality(w.getAirQuality());
		return weather.getId() != null ? weather : null;
	}
}
